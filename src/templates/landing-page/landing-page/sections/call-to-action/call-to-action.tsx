...
export const CallToAction = () => {
    return (
        <section className="bg-linear-180 from-blue-400 relative">
            <div className="absolute inset-0 bg-[url(/background-footer.svg)] bg-cover bg-center bg-no-repeat opacity-90" />

            <SiteContainer className="relative px-5 sm:px-4">
                <div className=" relative flex flex-col gap-8 md:gap-10 justify-center items-center py-14 md:py-20">
                    ...
                    <h2 className="font-sans text-gray-100 text-2xl text-center md:text-3xl font-bold max-w-[30.6rem] m-auto">Crie uma loja online e inicie suas vendas ainda hoje</h2>
