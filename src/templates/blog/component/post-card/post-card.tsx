...
export default function PostCard({
    ...
    title,
    description,
    author: { imgUser, nameUser }
}: PostCardProps) {
    return (
        <Link
            href={`/blog/${slug}`}
            className="flex flex-col gap-2 p-2 rounded-xl border border-gray-400 bg-gray-600 hover:border-blue-300 transition-all duration-300"
        >
